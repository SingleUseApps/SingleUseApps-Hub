...
const APPS = {
    ...
    dupsweep: {
        name: "DupSweep",
        tagline: "Find and safely remove duplicate files, folders, and photos.",
        icon: "🧹",
        features: [
            "SHA-256 Verified Duplicate Detection",
            "Duplicate Folder Clustering & Merge",
            "Visual Photo Similarity (dHash + pHash)",
...
function selectApp(appId) {
    ...
    // Auto-select in the buy dropdown, and keep the widget in sync.
